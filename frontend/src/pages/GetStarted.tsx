      ...
      <div className="w-full max-w-6xl mx-auto p-4 space-y-8 py-8">
        ...
        <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
          <DrawerTrigger asChild>
            <Button
              size="lg"
              className="w-full max-w-md mx-auto flex rounded-full shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-shadow"
            >
          ...
          <DrawerContent className="max-h-[90vh]">
            <DrawerHeader>
              ...
              <DrawerDescription>Select the plan that best fits your needs</DrawerDescription>
            </DrawerHeader>
